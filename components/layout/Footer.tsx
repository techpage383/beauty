    ...
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-6xl mx-auto px-4 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <span className="w-8 h-8 bg-brand-600 rounded-lg flex items-center justify-center text-white text-xs font-black">
                TL
              </span>
              <span className="font-bold text-lg text-white">True Log</span>
            </div>
          ...
          <div>
            <p className="text-xs font-bold text-gray-500 tracking-widest mb-5">EXPLORE</p>
          ...
          <div>
            <p className="text-xs font-bold text-gray-500 tracking-widest mb-5">LEGAL</p>
            <nav className="flex flex-col gap-3 text-sm">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-gray-600">
          <p>© 2026 True Log. All rights reserved.</p>
