  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <div className="prose prose-sm max-w-none space-y-8 text-gray-700">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">第3条（第三者提供）</h2>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">第4条（情報の管理）</h2>
          <p className="leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 mb-3">第5条（開示・削除の請求）</h2>
          <p className="leading-relaxed">
